  ...
  ),
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive/10 text-destructive focus-visible:ring-destructive/25 dark:bg-destructive/20 dark:focus-visible:ring-destructive/35 [a]:hover:bg-destructive/20",
        outline:
